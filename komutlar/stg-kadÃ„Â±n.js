...
const tag = '✵'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '789194951979565109') 
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '809441026514223134')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '789194951967375412')
const genelchat = message.guild.channels.cache.find(c => c.id === '789194952688533558')
const savelog = message.guild.channels.cache.find(c => c.id === '800998361259704320')
